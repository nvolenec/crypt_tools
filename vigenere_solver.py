...
def try_key_length( key_length, one_letter_word_offsets, key_mask_try ):
    matching_words = []
...
if __name__ == "__main__":
    ...
    if args.keyword is not None:
        ...
        if args.smart:
            ...
            for a in all_possible_one_letter_word_combos:
                ...
                first = 0
                print( key_mask_try )
                guess_keys = try_key_length( int(args.length), one_letter_word_offsets, key_mask_try )
                if guess_keys:
                    print( guess_keys )
    ...
    else: #bruteforce without length
